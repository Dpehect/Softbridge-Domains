...
const productGroups: ProductGroup[] = [
  {
    ...
    items: [
      ...
      { name: "Pineview Ledger", domain: "pineviewledger.com", price: 500, mrr: 105, traffic: 1900, note: "Simple finance and invoice platform name for local teams." },
      { name: "Oak County Forms", domain: "oakcountyforms.com", price: 500, mrr: 70, traffic: 1300, note: "Form builder identity suited to contractors and small offices." },
      { name: "Riverbend Reports", domain: "riverbendreports.com", price: 500, mrr: 135, traffic: 3100, note: "Reporting dashboard brand for regional operations." },
    ],
  },
  {
    category: "Portfolio",
    ...
    items: [
      ...
      { name: "Red Porch Works", domain: "redporchworks.com", price: 500, mrr: 40, traffic: 860, note: "Personal work showcase for makers, writers, or builders." },
      { name: "Stone Alley Maker", domain: "stonealleymaker.com", price: 500, mrr: 55, traffic: 1250, note: "Handmade, design, and case-study friendly brand." },
      { name: "Creekside Folio", domain: "creeksidefolio.com", price: 500, mrr: 35, traffic: 740, note: "Short portfolio domain for independent creative work." },
    ],
  },
  {
    category: "E-Commerce",
    ...
    items: [
      ...
      { name: "Red Barn Collective", domain: "redbarncollective.store", price: 500, mrr: 85, traffic: 2100, note: "Handmade market identity with a regional craft feel." },
      { name: "Riverbend Supply", domain: "riverbendsupply.com", price: 500, mrr: 115, traffic: 3400, note: "Hardware, outdoor, or farm supply storefront name." },
      { name: "Cloverfield Books", domain: "cloverfieldbooks.com", price: 500, mrr: 75, traffic: 1800, note: "Bookshop and subscription storefront with a friendly tone." },
    ],
  },
  {
    category: "Domain",
    ...
    items: [
      { name: "Oakridge Diner", domain: "oakridgediner.com", price: 500, mrr: 95, traffic: 2600, note: "Classic diner domain with immediate local business fit." },
      { name: "Cedar Hollow Cafe", domain: "cedarhollowcafe.com", price: 500, mrr: 80, traffic: 2200, note: "Cafe and bakery name that feels established but approachable." },
      { name: "Pineview Station", domain: "pineviewstation.com", price: 500, mrr: 110, traffic: 3000, note: "Flexible name for a depot, market, or neighborhood service hub." },
      { name: "Stonebridge Print Co.", domain: "stonebridgeprintco.com", price: 500, mrr: 65, traffic: 1400, note: "Print shop and local studio domain with clear service intent." },
      { name: "Maple Lane Repair", domain: "maplelanerepair.com", price: 500, mrr: 35, traffic: 620, note: "Small repair business name ready for a practical website." },
    ],
  },
  {
    category: "Agency",
    ...
    items: [
      ...
      { name: "Railtown Design", domain: "railtowndesign.com", price: 500, mrr: 80, traffic: 1500, note: "Design agency name with a modest regional voice." },
      { name: "Cloverfield Creative", domain: "cloverfieldcreative.com", price: 500, mrr: 90, traffic: 1800, note: "Creative studio identity for local brand and web work." },
      { name: "Maple Lane Agency", domain: "maplelaneagency.com", price: 500, mrr: 65, traffic: 980, note: "Approachable agency name for service packages and retainers." },
    ],
  },
  {
    category: "Blog",
    ...
    items: [
      ...
      { name: "Cedar Hollow Notes", domain: "cedarhollownotes.com", price: 500, mrr: 35, traffic: 920, note: "Small editorial brand for personal or community publishing." },
      { name: "Westfield Dispatch", domain: "westfielddispatch.com", price: 500, mrr: 75, traffic: 3100, note: "Regional blog or small newspaper name." },
      { name: "Little Acre Letter", domain: "littleacreletter.com", price: 500, mrr: 30, traffic: 700, note: "Newsletter-first name for lifestyle and local updates." },
    ],
  },
  {
    category: "Dashboard",
    ...
    items: [
      ...
      { name: "Ashford Board", domain: "ashfordboard.com", price: 500, mrr: 65, traffic: 1100, note: "Internal board name for teams, jobs, and office tasks." },
      { name: "Harbor Shift", domain: "harborshift.app", price: 500, mrr: 80, traffic: 1650, note: "Shift planning identity for cafes, shops, and crews." },
      { name: "Brookside Ops", domain: "brooksideops.com", price: 500, mrr: 95, traffic: 2050, note: "Operations dashboard brand with a grounded local tone." },
    ],
  },
  {
    ...
    items: [
      { name: "Oakridge Supper Club", domain: "oakridgesupperclub.com", price: 500, mrr: 25, traffic: 620, note: "Simple one-page launch for a local restaurant or event." },
      { name: "Cedar Hollow Roast", domain: "cedarhollowroast.com", price: 500, mrr: 20, traffic: 540, note: "Coffee popup or small batch product landing page." },
      { name: "Maple Grove Cakes", domain: "maplegrovecakes.com", price: 500, mrr: 30, traffic: 760, note: "Focused landing page for orders, menus, and calls." },
      { name: "Red Barn Weekend", domain: "redbarnweekend.com", price: 500, mrr: 18, traffic: 430, note: "Event and seasonal campaign name with local charm." },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Hollow Creek Works", domain: "hollowcreekworks.com", price: 500, mrr: 75, traffic: 1250, note: "Startup name that feels practical and handmade." },
      { name: "Lantern Lane Apps", domain: "lanternlaneapps.com", price: 500, mrr: 65, traffic: 1050, note: "Friendly app studio identity for a modest launch." },
      { name: "Stone Mill Systems", domain: "stonemillsystems.com", price: 500, mrr: 140, traffic: 3100, note: "Small systems company name with durable appeal." },
    ],
  },
  {
    category: "Corporate",
    ...
    items: [
      ...
      { name: "Harbor Plain Group", domain: "harborplaingroup.com", price: 500, mrr: 115, traffic: 2400, note: "Small holding or services group name for local markets." },
      { name: "Oak County Services", domain: "oakcountyservices.com", price: 500, mrr: 95, traffic: 1900, note: "Clear domain for a practical regional services firm." },
      { name: "Redfield Office", domain: "redfieldoffice.com", price: 500, mrr: 70, traffic: 1300, note: "Office services or consultancy name with a modest footprint." },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Clara Finch Notes", domain: "clarafinchnotes.com", price: 500, mrr: 28, traffic: 540, note: "Personal writing and newsletter domain." },
      { name: "Jonah Brooks Co.", domain: "jonahbrooksco.com", price: 500, mrr: 38, traffic: 760, note: "Independent consultant brand with local feel." },
      { name: "Nora Lane Studio", domain: "noralane.studio", price: 500, mrr: 50, traffic: 980, note: "Premium but small-scale personal brand domain." },
    ],
  },
  {
    category: "Education",
    ...
    items: [
      ...
      { name: "Cedar Creek Academy", domain: "cedarcreekacademy.com", price: 500, mrr: 110, traffic: 2800, note: "Education brand for courses, cohorts, or workshops." },
      { name: "Little Lantern Learning", domain: "littlelanternlearning.com", price: 500, mrr: 55, traffic: 980, note: "Friendly name for children, workshops, or tutoring." },
      { name: "Oakridge Workshops", domain: "oakridgeworkshops.com", price: 500, mrr: 45, traffic: 840, note: "Community learning and workshop domain." },
    ],
  },
  {
    category: "Healthcare",
    ...
    items: [
      ...
      { name: "Maple Street Wellness", domain: "maplestreetwellness.com", price: 500, mrr: 90, traffic: 1900, note: "Wellness practice domain for local providers." },
      { name: "Oakridge Family Health", domain: "oakridgefamilyhealth.com", price: 500, mrr: 120, traffic: 3100, note: "Family clinic identity with clear service positioning." },
      { name: "Riverbend Therapy", domain: "riverbendtherapy.com", price: 500, mrr: 75, traffic: 1500, note: "Therapy practice name with warm regional character." },
    ],
  },
];
